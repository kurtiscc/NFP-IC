    ...
    public sealed partial class TrackSampleView : Page
    {
        ...
        async private void UpdateLocationData(Geoposition position)
        {
            ...
            else
            {
                ...
                TagUIDPopulated.Text = tagUID;
                TimePopulated.Text = getCurrentTimeStamp();
                LatitudePopulated.Text = Stringlat;
                LongitudePopulated.Text = Stringlng;
                AddressPopulated.Text = addressString;
